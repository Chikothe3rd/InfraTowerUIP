...
exports.checkFuelTheftAndTemp = checkFuelTheftAndTemp;
exports.checkPredictiveIndicators = checkPredictiveIndicators;
exports.calculateRollingSla = calculateRollingSla;
exports.startIntelligenceService = startIntelligenceService;
exports.stopIntelligenceService = stopIntelligenceService;
const client_1 = require("@prisma/client");
const websocket_1 = require("./websocket");
const prisma = new client_1.PrismaClient();
async function sendAlert(towerId, type, severity, message) {
    try {
...
async function checkFuelTheftAndTemp() {
    try {
...
async function checkPredictiveIndicators() {
    try {
        const towers = await prisma.tower.findMany({
...
async function calculateRollingSla() {
    try {
        const towers = await prisma.tower.findMany({
            select: { id: true, siteCode: true }
        });
...
function startIntelligenceService() {
    console.log('==================================================');
...
function stopIntelligenceService() {
    if (anomalyInterval)
